...
extern "C" void* mira_entry(void* args)
{
	...
	int32_t currentSize = hen_todex_size;
	buffer = (uint8_t *)hen_todex_start;
		...
		buffer[3] == ELFMAG3) // 0x7F 'ELF'
	{
		...
		WriteNotificationLog("launching payload2");
